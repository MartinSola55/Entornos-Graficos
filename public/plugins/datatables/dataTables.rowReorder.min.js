    ...
    "function" == typeof define && define.amd
        ...
        ? ((r = require("jquery")),
          ...
          "undefined" != typeof window
              ...
              : (n(window, r),
                (module.exports = o(r, window, window.document))))
            ...
            (v.extend(s.prototype, {
                ...
                _cachePositions: function () {
                    var t = this.s.dt,
                        ...
                        e = v.unique(
                            t.rows({ page: "current" }).nodes().toArray()
                        ),
                    ...
                    var e = this.s.start,
                        ...
                        r =
                            !0 === r
                                ...
                                : t +
                                  e.offsetLeft +
                                  this.dom.cloneParent.scrollLeft();
                    o < 0
                        ? (o = 0)
                        : o + this.s.domCloneOuterHeight >
                    ...
                    for (
                        var e,
                            ...
                            d =
                                ...
                                this.dom.target.removeClass(
                                    "dt-rowReorder-moving"
                                ),
                                v(b).off(".rowReorder"),
                                v(b.body).removeClass(
                                ...
                                this.s.start.nodes),
                            l = v.unique(
                                s.rows({ page: "current" }).nodes().toArray()
                            ),
                            a = {},
                            c = [],
                            h = [],
                    ...
                    this.c.editor
                        ? ((this.c.enable = !1),
                          this.c.editor
                              ...
                              .multiSet(i, a)
                              .one(
                                  "preSubmitCancelled.rowReorder",
                                  function () {
                                      (n.c.enable = !0),
                                          n.c.editor.off(".rowReorder"),
                                          s.draw(!1);
                                  }
                              )
                              .one(
                                  "submitUnsuccessful.rowReorder",
                                  function () {
                                      s.draw(!1);
                                  }
                              )
                        ...
                        !this.s.scrollInterval &&
                            ...
                            (this.s.scrollInterval = setInterval(function () {
                                ...
                                n.windowVert &&
                                    ...
                                    t !== v(b).scrollTop()) &&
                                    ((t = parseFloat(
                                        r.dom.cloneParent.css("top")
                                    )),
                                    r.dom.cloneParent.css(
                                        "top",
                                        t + n.windowVert
                                    )),
                                    n.dtVert &&
